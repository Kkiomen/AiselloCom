<x-app-layout>
    ...
    <div class="max-w-3xl">
        <form action="{{ route('user-prompts.update', $userPrompt) }}" method="POST" class="card">
            @csrf
            @method('PUT')
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <input
                        ...
                        value="{{ old('name', $userPrompt->name) }}"
                        required
                    >
                    @error('name')
                ...
                <div>
                    ...
                    <textarea
                        ...
                        required
                    >{{ old('prompt_template', $userPrompt->prompt_template) }}</textarea>
                ...
                <div>
                    <label class="flex items-center space-x-3 cursor-pointer">
                        <input
                            ...
                            {{ old('is_default', $userPrompt->is_default) ? 'checked' : '' }}
                        >
