...
/**
 * Request walidacji dla asynchronicznego generowania opisu.
 * Validation request for async description generation.
 */
class GenerateDescriptionAsyncRequest extends FormRequest
{
    /**
    ...
    public function messages(): array
    {
        return [
            ...
            'external_product_id.string' => __('api.validation.external_product_id_string'),
            'external_product_id.max' => __('api.validation.external_product_id_max'),
        ];
    }
}
